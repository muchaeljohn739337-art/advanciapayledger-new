...
const BusinessEcosystem = () => {
  ...
  const getStatusIcon = (status?: string) => {
    return status === "launched" || status === "in_progress"
      ? CheckCircle2
      : Circle;
  };
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-300">
                ...
                <span className="font-bold text-green-400">
                  ${totalRevenue.min}K-${totalRevenue.max}K MRR
                </span>
              </span>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {Object.entries(ecosystemHubs).map(([key, hub]) => {
            const Icon = hub.icon;
            const inProgress = hub.opportunities.filter(
              (o) => o.status === "in_progress" || o.status === "planning",
            ).length;
            return (
              <div
                key={key}
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <StatusIcon
                        className={`w-5 h-5 ${getStatusColor(opp.status)}`}
                      />
                    </div>
        ...
        <div className="mt-12 text-center text-slate-400 text-sm">
          ...
          <p className="mt-2">
            Built on your existing tech stack + domain expertise
          </p>
        </div>
      </div>
    </div>
